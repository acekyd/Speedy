...
def get_max(rarity: str, current_level: int, card: int) -> int:
    ...
    match rarity:
        case "Special":
            cards = [300, 30, 60, 90, 120, 150, 180, 210, 240, 270, 300, 350, 400, 450, 500, 600]
...
class Special(interactions.Extension):
        ...
        embed.add_field(
            ...
            value="".join(
                [
                    ...
                    "<:specialcard:1064631403007975424> : " + (f"{a[1]}{a[2]}\n" if str(a[2]) != "" else "Maximum Level Reached\n"),
    ...
    async def special_char(self, ctx: interactions.CommandContext, character_name: str = "") -> None:
