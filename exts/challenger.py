...
def get_max(rarity: str, current_level: int, card: int) -> int:
    ...
    match rarity:
        case "Challenger":
            cards = [500, 20, 50, 100, 170, 250, 350, 500, 700, 1000, 1400, 1900, 2500, 3200, 4000, 5000]
...
class Challenger(interactions.Extension):
        ...
        embed.add_field(
            ...
            value="".join(
                [
                    ...
                    "<:challenger:1064631495341391903> : " + (f"{a[1]}{a[2]}\n" if str(a[2]) != "" else "Maximum Level Reached\n"),
    ...
    async def challenger_char(self, ctx: interactions.CommandContext, character_name: str = "") -> None:
